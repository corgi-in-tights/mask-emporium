...
public class FortunasBallet extends SimpleMask {
    public FortunasBallet(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(new TranslatableText("item.masks.fortunas_ballet.tooltip").formatted(Formatting.GRAY) );
    }
}